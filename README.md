...
## Запуск в dev режиме
В файле .env в корне проекта необходимо задать все параметры предоставленные в .env.example</br>
Тоже самое надо сделать с файлом .env в директории ./vuejs</br>
